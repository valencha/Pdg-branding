...
let listCategory =[
   ...
   },
    {
        id:2,
       label:'Maderosos',
       urlImage:'/images/maderosos.png',
       select:false
   },
   {
        id:3,
        label:'Frutales',
        urlImage:'/images/frutales.png',
        select:false
    },
    {
        id:4,
        label:'Cítricos',
        urlImage:'/images/citricos.png',
        select:false
    },
    {
        id:4,
        label:'Océanicas',
        urlImage:'/images/oceanicos.png',
        select:false
    },
            ...
            <div className={classes.content}>
                ...
                <div className={classes.contentRight}>
                    ...
                    <div className={classes.contentText}>
                        <h1 className={classes.titleStep}>Sentido olfativo</h1>
                        <p className={classes.description}><span className={classes.bold}>1. </span>De acuerdo a las esencias que exploraste en el Kit, <span className={classes.bold}>selecciona el/los aromas </span>que más se acoplen a la marca de tu proyecto/emprendimiento/empresa.</p>
