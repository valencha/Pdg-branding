...
let listCategory =[
   ...
   },
    {
        id:2,
       label:'Palo seco',
       urlImage:'/images/paloseco.png',
       select:false
   },
   {
        id:3,
        label:'Manuescrita',
        urlImage:'/images/manuescrita.png',
        select:false
    },

    {
        id:4,
        label:'Condensada',
        urlImage:'/images/condensada.png',
        select:false
    },
    {
        id:5,
        label:'Negrita',
        urlImage:'/images/negrita.png',
        select:false
    },
    {
        id:6,
        label:'Light',
        urlImage:'/images/light.png',
        select:false
    },
]
...
function StepVisual4(){
    ...
    const [disabled, setDisabled] = React.useState(true);
      ...
      function handleBackPage(event){
        ...
        history.push('/dashboard/'+project+'/'+id+'/stepvisual3');
      }
            ...
            <div className={classes.content}>
                ...
                <div className={classes.contentRight}>
                    ...
                    <div className={classes.contentText}>
                        ...
                        <p className={classes.description}><span className={classes.bold}>4. </span>De acuerdo a los recursos visuales que exploraste y escaneaste en las tarjetas del Kit, <span className={classes.bold}>selecciona las tipografías </span>que más se acoplen a la marca de tu proyecto/emprendimiento/empresa.</p>
