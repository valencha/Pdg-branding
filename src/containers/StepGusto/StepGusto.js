...
let listCategory =[
...

    {
        id:3,
        label:'Ácidos',
        urlImage:'/images/acidos.png',
        select:false
    },
    {
        id:4,
        label:'Amargos',
        urlImage:'/images/amargos.png',
        select:false
    },
    
    {
        id:5,
        label:'Picantes',
        urlImage:'/images/picantes.png',
        select:false
    },
    {
        id:6,
        label:'Umami',
        urlImage:'/images/umami.png',
        select:false
    },
...
function StepGusto(){
    ...
    const [disabled, setDisabled] = React.useState(true);
      ...
      function handleNextPage(event){
        ...
        history.push('/dashboard/'+project+'/'+id+'/stepgusto2');
      }
            ...
            <div className={classes.content}>
                ...
                <div className={classes.contentRight}>
                    ...
                    <div className={classes.contentText}>
                        ...
                        <p className={classes.description}><span className={classes.bold}>1. </span>De acuerdo a las tarjetas de representaciones gustativas que exploraste en el Kit, <span className={classes.bold}>selecciona el/los sabores </span>que más se acoplen a la marca de tu proyecto/emprendimiento/empresa.</p>
