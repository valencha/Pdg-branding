...
let listImg=[
 ...
 let  listVideo=[
    ...
    {
      "video": '/videos/escuela.mp4',
      "url":'/images/db/escuela.png',
      "nombre": "escuela",
      "select": false,
      "tipo": "video",
      "categoria": "general",
    ...
    {
      "video": '/videos/flores.mp4',
      "url":'/images/db/tulipanes.png',
      "nombre": "tulipanes",
      "select": false,
      "tipo": "video",
      "categoria": "general",
    ...
    {
      "video": '/videos/negocios.mp4',
      "url":'/images/db/negocios.png',
      "nombre": "negocios",
      "select": false,
      "tipo": "video",
      "categoria": "general",
   ...
   let  listSound=[
    ...
    {
      "audio": "/sounds/guitarraE.mp3",
      "url":'/images/db/guitarraE.jpg',
      "nombre": "guitarraE",
      "select": false,
      "tipo": "audio",
      "categoria": "general",
    ...
    {
      "audio": "/sounds/jazz.mp3",
      "url":'/images/db/jazz.jpg',
      "nombre": "jazz",
      "select": false,
      "tipo": "audio",
      "categoria": "general",
    ...
    {
      "audio": "/sounds/samba.mp3",
      "url":'/images/db/samba.jpg',
      "nombre": "samba",
      "select": false,
      "tipo": "audio",
      "categoria": "general",
