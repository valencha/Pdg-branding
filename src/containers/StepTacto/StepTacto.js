...
let listCategory =[
   ...
   },
    {
        id:2,
       label:'Frías',
       urlImage:'/images/frias.png',
       select:false
   },
   {
        id:3,
        label:'Rugosas',
        urlImage:'/images/rugosas.png',
        select:false
    },
    {
        id:4,
        label:'Lisas',
        urlImage:'/images/lisas.png',
        select:false
    },
    {
        id:4,
        label:'Brillantes',
        urlImage:'/images/brillantes.png',
        select:false
    },
...
function StepTacto(){
    ...
    const [disabled, setDisabled] = React.useState(true);
      ...
      function handleNextPage(event){
        ...
        history.push('/dashboard/'+project+'/'+id+'/steptacto2');
      }
            ...
            <div className={classes.content}>
                ...
                <div className={classes.contentRight}>
                    ...
                    <div className={classes.contentText}>
                        ...
                        <p className={classes.description}><span className={classes.bold}>1. </span>De acuerdo a las tarjetas con textura que exploraste en el Kit, <span className={classes.bold}>selecciona la/las texturas </span>que más se acoplen a la marca de tu proyecto/emprendimiento/empresa.</p>
