        ...
        <Dialog classes={{paper: classes.paper}}  onClose={props.handleOpen} aria-labelledby="simple-dialog-title" open={props.open}>
            <div className={classes.content}>
                ...
                <div className={classes.contentText}>
                    ...
                    <span className={classes.textB}>¡Felicitaciones! </span>Has completado todo el progreso de la creación o redefinición de marca
                    </h1>
                <div className={classes.containText}>
                <p className={classes.text}>Has desbloqueado:</p>
                <img className={classes.imgLogro} width='222px' src={('/images/recursosDes.svg')} alt="logro" />

                </div>
              
                </div>
                <button onClick={props.handleGoHome} className={classes.btn}>Ir al inicio  <img className ={classes.icon} alt='arrow'  src={('/images/arrow.svg')} /> </button>
