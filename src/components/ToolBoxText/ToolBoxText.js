...
function ToolBoxText(props){
    ...
    return (
        <div className={classes.body}>
            ...
            <Button className={classes.btnTool} onClick={props.handleSaveF}> <div className={classes.contentBtn}><img src='/images/guardarText.svg'alt="upload" width='24px' /></div> </Button>
